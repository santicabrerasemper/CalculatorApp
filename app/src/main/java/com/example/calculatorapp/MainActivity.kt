...
class MainActivity : AppCompatActivity() {
    ...
    private fun setListeners() {
        ...
        with(binding) {
            ...
            imgNightMode.setOnClickListener {  toggleNightMode()}
        }
    }
    ...
    private fun setNightModeIndicator() {
        if (AppCompatDelegate.getDefaultNightMode() == AppCompatDelegate.MODE_NIGHT_YES){
            binding.imgNightMode.setImageResource(R.drawable.contrast)
        } else {
            binding.imgNightMode.setImageResource(R.drawable.halfmoon)
        }
    }
